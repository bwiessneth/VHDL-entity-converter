...
{
	MSG(GROUP::DEBUG, DEBUG::FUNCTIONCALL) << "Markdown::Markdown(VHDLEntity sourceEntity)";
...
std::string Markdown::Polarity(int i)
{
...
std::string Markdown::Direction(int i)
{
...
std::string Markdown::Type(int i)
{
...
void Markdown::getGenerics()
{
	...
	if (mSourceEntity.getNumberOfGenerics() > 0)
	{
		...
		if (cfg.getBool("Table.boldHeadings"))
			writeCell(colNames::GenericName, cfg.getString("Table.GenericName"), " **", "** ", " ");
		else
			writeCell(colNames::GenericName, cfg.getString("Table.GenericName"), " ", " ", " ");
		...
		if (cfg.getBool("Table.boldHeadings"))
			writeCell(colNames::GenericType, cfg.getString("Table.GenericType"), " **", "** ", " ");
		else
			writeCell(colNames::GenericType, cfg.getString("Table.GenericType"), " ", " ", " ");
		...
		if (cfg.getBool("Table.boldHeadings"))
			writeCell(colNames::DefaultValue, cfg.getString("Table.GenericDefaultValue"), " **", "** ", " ");
		else
			writeCell(colNames::DefaultValue, cfg.getString("Table.GenericDefaultValue"), " ", " ", " ");
...
void Markdown::getMaxTextLengths()
{
...
void Markdown::writeCell(colNames column, std::string text, std::string prefix, std::string suffix, std::string fillChar, bool formatting)
{

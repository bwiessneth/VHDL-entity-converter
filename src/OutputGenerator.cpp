...
void OutputGenerator::generateFODG()
{
...
// Generate a SVG file
void OutputGenerator::generateSVG()
{
	MSG(GROUP::DEBUG, DEBUG::FUNCTIONCALL) << "OutputGenerator::generateFODG()";
...
void OutputGenerator::generateDokuWikiMarkup()
{
	MSG(GROUP::DEBUG, DEBUG::FUNCTIONCALL) << "OutputGenerator::generateDokuWikiMarkup()";
...
void OutputGenerator::generateMarkdown()
{
	MSG(GROUP::DEBUG, DEBUG::FUNCTIONCALL) << "OutputGenerator::generateMarkdown()";
...
void OutputGenerator::generateLaTeX()
{
...
// Exclude filename (e.g. microdata.vhd) from filepath to get output directory (e.g. input = C:\VEC\microdata.vhd -> output = C:\VEC\)
std::string OutputGenerator::getOutputPath(std::string filePath)
{
	MSG(GROUP::DEBUG, DEBUG::FUNCTIONCALL) << "OutputGenerator::getOutputPath(std::string filePath)";

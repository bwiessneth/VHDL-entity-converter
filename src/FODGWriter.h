...
public:
  ...
  // Writes the FODG header to the output file. If width and height are given
  // the produced fodg file will have these dimensions
  ...
  void customShape(double x,
                   double y,
                   double width,
                   double height,
                   std::string label,
                   std::string shapeID = "gr1",
                   std::string textID = "P1");
